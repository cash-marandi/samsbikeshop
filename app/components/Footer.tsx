        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-4">
            <h3 className="text-xl font-bold flex items-center space-x-2">
              <span className="text-emerald-500">SAMS</span>
              <span>BIKE SHOP</span>
            </h3>
          ...
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest text-emerald-500 mb-6">Quick Links</h4>
          ...
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest text-emerald-500 mb-6">Support</h4>
            <ul className="space-y-3 text-sm text-zinc-400">
          ...
          <div>
            <h4 className="text-sm font-bold uppercase tracking-widest text-emerald-500 mb-6">Connect</h4>
