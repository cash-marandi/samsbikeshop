      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-300">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Please complete your payment via EFT</p>
          </div>

          <div className="bg-gray-50 rounded-lg p-6 mb-6">
            <h2 className="text-xl font-bold mb-4">Reference Number</h2>
            <p className="text-3xl font-bold text-orange-600 font-mono">{referenceNumber}</p>
            <p className="text-sm text-gray-500 mt-2">Use this as your payment reference</p>
          </div>
          ...
          <div className="bg-blue-50 rounded-lg p-6 mb-6 border border-blue-200">
            ...
            <div className="space-y-3">
              <div className="flex justify-between border-b border-blue-200 pb-2">
                ...
                <span className="text-gray-900">Sams Bike Shop and Mobile</span>
              </div>
              <div className="flex justify-between border-b border-blue-200 pb-2">
                <span className="font-semibold text-gray-700">Bank:</span>
                <span className="text-gray-900">Capitec</span>
              </div>
              <div className="flex justify-between border-b border-blue-200 pb-2">
                <span className="font-semibold text-gray-700">Account Type:</span>
                <span className="text-gray-900">Capitec Business</span>
              </div>
              <div className="flex justify-between border-b border-blue-200 pb-2">
                <span className="font-semibold text-gray-700">Account Number:</span>
                <span className="text-gray-900 font-mono">1054960860</span>
              </div>
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="flex-1 px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-900 font-bold rounded-lg transition-colors"
            >
              Print Invoice
            </button>
          </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg p-6 border border-gray-300 h-fit">
            ...
            <button
              type="submit"
              className="w-full mt-6 px-6 py-4 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-lg transition-colors"
            >
              Place Order
            </button>
            <Link href="/cart" className="block text-center mt-4 text-gray-600 hover:text-gray-900">
              ← Back to Cart
            </Link>
          </div>
        </div>
