  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
        <div>
          <h1 className="text-6xl font-black uppercase tracking-tighter mb-8 italic">Let's Talk <span className="text-blue-900">Gear.</span></h1>
          ...
          <div className="space-y-10">
            <div className="flex items-start gap-6">
              <div className="w-12 h-12 bg-zinc-900 rounded-2xl flex items-center justify-center text-blue-900 flex-shrink-0 border border-zinc-800">
          ...
          <form className="space-y-6" onSubmit={e => e.preventDefault()}>
            <div className="grid grid-cols-2 gap-6">
               <div className="space-y-2">
                 ...
                 <input type="text" className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-4 focus:outline-none focus:border-blue-900" placeholder="John Doe" />
               </div>
               <div className="space-y-2">
                 <label className="text-[10px] font-black uppercase tracking-widest text-zinc-500 ml-1">Email Address</label>
                 <input type="email" className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-4 focus:outline-none focus:border-blue-900" placeholder="john@domain.com" />
               </div>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <textarea className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-4 focus:outline-none focus:border-blue-900 min-h-[200px]" placeholder="How can we help you get back on the road?"></textarea>
            </div>
            <button className="w-full py-5 bg-blue-900 text-zinc-950 font-black rounded-2xl hover:bg-blue-950 hover:scale-[1.01] transition-all uppercase tracking-[0.2em]">Send Transmission</button>
          </form>
        </div>
      </div>
    </div>
