          ...
          <form className="space-y-6" onSubmit={e => e.preventDefault()}>
            <div className="grid grid-cols-2 gap-6">
               <div className="space-y-2">
                  ...
                  <input type="text" className="w-full bg-ink-50 border border-ink-200 rounded-xl px-4 py-4 focus:outline-none focus:border-flame-500" placeholder="John Doe" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-ink-600 ml-1">Email Address</label>
                  <input type="email" className="w-full bg-ink-50 border border-ink-200 rounded-xl px-4 py-4 focus:outline-none focus:border-flame-500" placeholder="john@domain.com" />
               </div>
            </div>
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-ink-600 ml-1">Appointment Date</label>
              <input type="date" className="w-full bg-ink-50 border border-ink-200 rounded-xl px-4 py-4 focus:outline-none focus:border-flame-500" />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase tracking-widest text-ink-600 ml-1">Subject</label>
              <select className="w-full bg-ink-50 border border-ink-200 rounded-xl px-4 py-4 focus:outline-none focus:border-flame-500 appearance-none">
            ...
            <div className="space-y-2">
              ...
              <textarea className="w-full bg-ink-50 border border-ink-200 rounded-xl px-4 py-4 focus:outline-none focus:border-flame-500 min-h-[200px]" placeholder="How can we help you get back on the road?"></textarea>
            </div>
            <button className="w-full py-5 bg-flame-500 text-white font-bold rounded-xl hover:bg-flame-600 transition-colors uppercase tracking-[0.2em]">Send Transmission</button>
          </form>
        </div>
      </div>
    </div>
