      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-8">
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-6 text-center">
            <div className="mb-6">
              <div className="w-16 h-16 bg-ink-100 rounded-full mx-auto mb-4 flex items-center justify-center">
                <svg className="w-8 h-8 text-ink-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                </svg>
              </div>
              <p className="text-ink-600 mb-6">This section is under construction. Please check back later for options to manage your payment methods.</p>
            </div>
            <button
