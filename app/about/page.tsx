...
export const metadata: Metadata = {
  title: 'About Us | Sam\'s Bike Shop - Est. 1998, Soweto',
  description: 'Learn about Sam\'s Bike Shop, Soweto\'s premier cycling hub since 1998. Founded by Samuel Maswanganyi, we offer expert repairs, premium bike sales, rentals, and auctions in Gauteng.',
  keywords: 'about sams bike shop, bike shop history, soweto cycling, samuel maswanganyi, bicycle shop gauteng',
  openGraph: {
    title: 'About Us | Sam\'s Bike Shop',
    description: 'Soweto\'s premier cycling hub since 1998. Expert repairs, premium sales, rentals, and auctions.',
    url: 'https://samsbikeshop.co.za/about',
    siteName: 'Sam\'s Bike Shop',
    type: 'website',
  },
}

const PLACEHOLDER_IMAGE_PATH = '/file.svg'
  ...
  return (
    <>
      ...
      <BreadcrumbJsonLd items={[
        ...
        { name: 'About', url: 'https://samsbikeshop.co.za/about' },
      ]} />
      <div className="space-y-24 pb-24">
        <section className="relative py-24 bg-ink-100 pt-28">
