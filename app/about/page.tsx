...
export default function AboutPage() {
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-screen text-gray-900 text-xl">Loading team information...</div>
    );
  }
    ...
    <div className="space-y-24 pb-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            <h1 className="text-7xl font-bold uppercase tracking-tighter mb-8 italic">
              WE LIVE <br />
              <span className="text-orange-500">AND BREATHE</span> <br />
              CYCLING.
            </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
        <div className="order-2 md:order-1">
          <Image src="https://picsum.photos/seed/workshop/800/1000" width={800} height={1000} className="rounded-lg grayscale border border-gray-300" alt="Workshop" />
        </div>
        <div className="order-1 md:order-2 space-y-10">
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              <h4 className="text-orange-500 font-bold uppercase text-xs tracking-widest mb-2">Expertise</h4>
              <p className="text-gray-700 text-sm">UCI Certified mechanics on-site for all performance builds.</p>
            </div>
            <div>
              <h4 className="text-orange-500 font-bold uppercase text-xs tracking-widest mb-2">Quality</h4>
              <p className="text-gray-700 text-sm">Only the finest components from global leaders like Shimano and SRAM.</p>
            </div>
            <div>
              <h4 className="text-orange-500 font-bold uppercase text-xs tracking-widest mb-2">Community</h4>
              <p className="text-gray-700 text-sm">Proud sponsors of regional youth racing and trail conservation.</p>
            </div>
            <div>
              <h4 className="text-orange-500 font-bold uppercase text-xs tracking-widest mb-2">Heritage</h4>
              <p className="text-gray-700 text-sm">25+ years of mechanical wisdom passed down through generations.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-lg border border-gray-300 text-center">
            ...
            <p className="text-gray-700">Explore Johannesburg on two wheels with our diverse fleet of rental bikes, perfect for casual rides or adventurous trails.</p>
          </div>
          <div className="bg-white p-8 rounded-lg border border-gray-300 text-center">
            <h3 className="text-xl font-bold mb-4 text-orange-500">Auctions & Vintage Finds</h3>
            <p className="text-gray-700">Participate in exciting auctions for unique bicycles, rare parts, and vintage accessories. Find your next treasure with us.</p>
          </div>
        </div>
      </section>
        ...
        {error ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {teamMembers.map(member => (
              <div key={member._id || member.id} className="bg-white p-8 rounded-lg border border-gray-300 text-center">
                <Image 
                ...
                <p className="text-orange-500 uppercase text-sm font-semibold mb-4">{member.role.replace('_', ' ')}</p>
                <p className="text-gray-700">Passionate team member dedicated to providing the best cycling experience for our customers.</p>
              </div>
            ))}
          </div>
        ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            <div className="bg-white p-8 rounded-lg border border-gray-300 text-center">
              ...
              <h3 className="text-2xl font-bold mb-2 text-gray-900">Sam Henderson</h3>
              <p className="text-orange-500 uppercase text-sm font-semibold mb-4">Founder & Master Mechanic</p>
              <p className="text-gray-700">With over 25 years of experience, Sam is the heart and soul of Sams Bike Shop, a true visionary in the cycling world.</p>
            </div>
            <div className="bg-white p-8 rounded-lg border border-gray-300 text-center">
              ...
              <h3 className="text-2xl font-bold mb-2 text-gray-900">Maria Lopez</h3>
              <p className="text-orange-500 uppercase text-sm font-semibold mb-4">Sales & Customer Relations</p>
              <p className="text-gray-700">Maria ensures every customer finds their perfect ride, providing unparalleled service and expert advice.</p>
            </div>
            <div className="bg-white p-8 rounded-lg border border-gray-300 text-center">
              ...
              <h3 className="text-2xl font-bold mb-2 text-gray-900">Thabo Mokoena</h3>
              <p className="text-orange-500 uppercase text-sm font-semibold mb-4">Bike Fit Specialist & Rentals</p>
              <p className="text-gray-700">Thabo combines precision bike fitting with managing our diverse rental fleet, making cycling accessible to everyone.</p>
            </div>
          </div>
        )}
      </section>
