    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          {MOCK_NEWS.map(post => (
            <article key={post.id} className="group">
              <div className="aspect-video rounded-3xl overflow-hidden mb-8 border border-zinc-800 relative">
                ...
                <div className="absolute top-6 left-6 bg-emerald-600 text-zinc-950 px-4 py-1 rounded-full text-xs font-black uppercase tracking-widest">
                  Featured News
                </div>
              </div>
              <div className="flex items-center gap-4 text-xs font-bold uppercase tracking-widest text-zinc-500 mb-4">
                <span className="text-emerald-500">{post.date}</span>
                <span className="w-1 h-1 rounded-full bg-zinc-800"></span>
                <span>By {post.author}</span>
              </div>
              <h2 className="text-4xl font-black mb-6 group-hover:text-emerald-400 transition-colors leading-tight">
                {post.title}
              </h2>
              ...
              <button className="text-emerald-500 font-black uppercase tracking-widest text-sm hover:translate-x-2 transition-transform inline-flex items-center gap-2">
                Continue Reading
        ...
        <aside className="space-y-12">
          ...
          <div className="bg-emerald-600 p-8 rounded-3xl relative overflow-hidden group cursor-pointer">
