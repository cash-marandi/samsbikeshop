...
export default function RentalsPageContent({ rentalBikes }: { rentalBikes: any[] }) {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-12">
      ...
      <section className="mb-12">
        <p className="text-ink-600 leading-relaxed max-w-3xl">
          Explore Johannesburg and Soweto on two wheels with Sam&apos;s Bike Shop premium rental fleet. We offer mountain bikes, road bikes, and hybrid bicycles for daily, weekend, and weekly rentals. Every rental includes a helmet, lock, and basic repair kit. Our flexible booking system lets you reserve online with instant confirmation. Whether you&apos;re tackling the Witpoortjie trails, cruising through Walter Sisulu Botanical Gardens, or commuting through Protea Glen, we have the perfect bike for your adventure. Long-term and group rentals available at discounted rates.
        </p>
      </section>

      {rentalBikes.length > 0 ? (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {rentalBikes.map((bike: RentalBike) => (
      ...
      <div className="mt-24 max-w-3xl mx-auto">
        ...
        <div className="bg-ink-100 rounded-lg p-6 space-y-6">
          <div>
            <h3 className="font-bold text-ink-900 mb-2">What&apos;s included in the rental?</h3>
            <p className="text-ink-600">Every rental includes the bicycle, helmet, lock, and a basic repair kit. Premium rentals include cycling gloves and a water bottle cage.</p>
          </div>
          <div>
            <h3 className="font-bold text-ink-900 mb-2">Is there insurance on rental bikes?</h3>
            <p className="text-ink-600">A minimal insurance fee is included in all rentals to cover accidental damage. Coverage details are provided at booking.</p>
          </div>
          <div>
            <h3 className="font-bold text-ink-900 mb-2">Can I rent for multiple days?</h3>
            <p className="text-ink-600">Yes! We offer daily, weekend, and weekly rental rates. Long-term rentals are available at discounted rates.</p>
          </div>
          <div>
            <h3 className="font-bold text-ink-900 mb-2">What if the bike gets damaged?</h3>
            <p className="text-ink-600">Minor wear is expected. For significant damage, your insurance cover applies. Contact us immediately and we&apos;ll arrange a replacement.</p>
          </div>
        </div>
      </div>
    </div>
