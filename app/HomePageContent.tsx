...
export default function HomePageContent({ products, auctions, newsPosts }: HomePageContentProps) {
  ...
  const activeAuctions = auctions.filter((a: any) => a.status === 'LIVE' || a.status === 'UPCOMING');
